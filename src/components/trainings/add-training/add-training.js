...
const TrainingCardAdd = (props) => {
  return (
    <React.Fragment>
      <section className="add-workout container">
            ...
            <div className="card-item">
              <div className="card-header">
                <div className="card-header__func card-header--left">
                  <div className="card-header__func-item">
                  ...
                  <input className="card-header__func-item card-header__func--input" type="number" placeholder="0" id="time"/>
                ...
                <div className="card-content card-content--add-workout">
                  <div className="card-content__workout">
                    <div className="input-wrapper">
                      <input className="card-content__workout-item card-content--input" type="number" placeholder="0" id="reps"/>
                      <span>x</span>
                      <input className="card-content__workout-item card-content--input input-sets" type="number" placeholder="0" id="sets"/>
                    </div>
                  </div>
                  ...
                  <div className="input-wrapper">
                    <input className="card-content__workout-item card-content--input minutes" type="number" placeholder="0" id="minutes"/>
